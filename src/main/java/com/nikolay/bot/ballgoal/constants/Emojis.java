...
public class Emojis {
    ...
    public static final String EMOJI_STATUS =
            new String(new byte[]{(byte) 0xE2, (byte) 0x8F, (byte) 0xB3}, StandardCharsets.UTF_8);

    public static final String EMOJI_MINUTE =
            new String(new byte[]{(byte) 0xE2, (byte) 0x93, (byte) 0x82}, StandardCharsets.UTF_8);

    public static final String EMOJI_BALL =
            new String(new byte[]{(byte) 0xE2, (byte) 0x9A, (byte) 0xBD}, StandardCharsets.UTF_8);
}
